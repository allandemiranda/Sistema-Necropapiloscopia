						...
						<form action="" method="POST">
							...
							<div class="typo-buttons col-md-12 grid_4">
								<div class="col-md-12 well">
									...
									<input name="nome" class="col-md-3" type="text" placeholder="Nome" maxlength="100" required>
									<input name="sobre_nome" class="col-md-5" type="text" placeholder="Sobrenome" maxlength="100" required>
								</div>
								<div class="col-md-12 well">
								...
								<div class="col-md-12 well">
									...
									<input name="usuario" class="col-md-3" type="text" maxlength="50" required>
								</div>
								<div class="col-md-12 well">
									<label class="col-md-4">Senha </label>
									<input name="senha" class="col-md-3" type="password" maxlength="50" required>
								</div>
								<div class="grid1">
